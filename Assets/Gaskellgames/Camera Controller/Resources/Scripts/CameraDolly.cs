...
namespace Gaskellgames.CameraController
{
    ...
    public class CameraDolly : MonoBehaviour
    {
        ...
        [SerializeField] private bool flipStartDirection;
        [SerializeField] private bool updateRotation;
        
        //[Header("References"), Space]
        [LineSeparator]
        
        [SerializeField, RequiredField] private CameraTrack cameraTrack;
        [SerializeField, RequiredField] private Transform lookAt;
