...
namespace Gaskellgames.CameraController
{
    public class CameraRig : MonoBehaviour
    {
        ...
        [SerializeField] private bool registerCamera = true;
        [SerializeField] private bool freeFlyCamera;
        [SerializeField] private bool cameraShake;
        
        [LineSeparator]
        
        [SerializeField, RequiredField] private GMKInputController gmkInputController;
        [SerializeField, Range(0, 100)] private float moveSpeed = 10;
        [SerializeField, Range(0, 100)] private float boostSpeed = 25;
        [SerializeField, Range(0, 100)] private int xSensitivity = 50;
        [SerializeField, Range(0, 100)] private int ySensitivity = 50;
        [SerializeField] private bool freeFlyActive;
