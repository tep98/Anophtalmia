...
namespace Gaskellgames.CameraController
{
    public class CameraMultiTarget : MonoBehaviour
    {
        ...
        [SerializeField] private Color defaultColor = new Color32(000, 079, 223, 255);
        [SerializeField] private Color trackedColor = new Color32(000, 179, 223, 255);
        [SerializeField] private bool gizmosOnSelected = true;
        [SerializeField] private bool zoomCamera;
        [LineSeparator]
        [SerializeField, RequiredField, Space] private Transform refCamLookAt;
        [SerializeField, Range(0, 10)] private float moveSpeed = 2.0f;
        [LineSeparator]
        [SerializeField, RequiredField] private CameraRig cameraRig;
        [SerializeField] private bool boundsX;
        [SerializeField] private bool boundsY;
        [SerializeField] private bool boundsZ;
        [SerializeField, Range(0, 50)] private int padding = 10;
        [SerializeField, Range(0, 120)] private int minZoom = 50;
        [SerializeField, Range(0, 120)] private int maxZoom = 10;
        [SerializeField, Range(0, 10)] private float zoomSpeed = 2.0f;
        [LineSeparator]
