...
namespace Gaskellgames.CameraController
{
    public class GaskellgamesMenuItemCameraController : GaskellgamesMenuItem
    {
        ...
        {
            // create a custom gameObject, register in the undo system, parent and set position relative to context
            GMKInputController gmk = GaskellgamesMenuItemInputEventSystem.AddPlayerInputController(menuCommand);
        ...
        private static void Gaskellgames_GameobjectMenu_CameraFreelookRig(MenuCommand menuCommand)
        {
            ...
            GaskellgamesMenuItemInputEventSystem.AddInputActionsManager(menuCommand);
